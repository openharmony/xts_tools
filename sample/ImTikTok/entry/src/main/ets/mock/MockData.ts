 ...
 */
import User from '../imtiktok/data/User';
import Tool from '../imtiktok/data/Tool';
import { SearchResult, AudioInfo, VideoDetailInfo, VideoInfo } from '../imtiktok/data/SearchResult'
...
function getVideoDetailInfoList(): Array<Array<VideoDetailInfo>> {
  let videoDetailInfoList: Array<Array<VideoDetailInfo>> = [
    ...
    [
      new VideoDetailInfo(1, '青鸟艺术声乐培训', $r('app.media.app_icon'), '2022.06.10', '给高考准备的一首歌', '#青鸟艺术声乐培训#高考#抖音小助手', '85.6w', '3.6w', '6.2w', '6.0w', 'demo_video.mp4', '小小的太阳', $r('app.media.app_icon'), '我的喉咙只适合做核酸', '4.5万'),

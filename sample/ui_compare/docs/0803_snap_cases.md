...
| `SUB_ACE_UI_COMPONENT_MEDIA_MINOR_LANGUAGE_0051` | type设置为ToggleType.Switch的Toggle，不关闭应用程序，切换系统语言种类为泰语、葡萄牙语、印尼语、德语、土耳其语、意大利语、缅甸语、老挝语、波兰语、马来语、英国英语测试 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_MINOR_LANGUAGE_0053` | Refresh下拉刷新，不关闭应用程序，切换系统语言种类为泰语、葡萄牙语、印尼语、德语、土耳其语、意大利语、缅甸语、老挝语、波兰语、马来语、英国英语测试 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_DC_0033` | 压力测试多DC容器加在多个组件，设置组件属性，预期属性功能正常切换 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_MINOR_LANGUAGE_0050` | type设置为ToggleType.Switch的Toggle，退出应用程序，切换系统语言种类为泰语、葡萄牙语、印尼语、德语、土耳其语、意大利语、缅甸语、老挝语、波兰语、马来语、英国英语测试 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_MINOR_LANGUAGE_0052` | Refresh下拉刷新，退出应用程序，切换系统语言种类为泰语、葡萄牙语、印尼语、德语、土耳其语、意大利语、缅甸语、老挝语、波兰语、马来语、英国英语测试 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_DC_0035` | 压力测试多个DC容器内加载多个组件，设置组件属性，预期属性功能正常切换 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_MINOR_LANGUAGE_0031` | Refresh下拉刷新，不关闭应用程序，切换系统语言种类为高棉语/哈萨克语/白俄罗斯语/乌兹别克语测试 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_MINOR_LANGUAGE_0021` | 显示"更多"的Navigation，不关闭应用程序，切换系统语言种类为高棉语/哈萨克语/白俄罗斯语/乌兹别克语测试 | 组件1组 |
...
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00927` | 文本编辑器图片类正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00930` | 相机图片类正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_TUKU_0013` | 图库大屏横屏多任务切换 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_ACTION_00210` | 云图数据量1000+，云空间中图库同步开启，图库下行过程中，已下行数据重命名成功 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00922` | 数据克隆图片类正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00928` | 我的华为图片类正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00923` | 设置图片类正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00915` | 电子邮件图片类正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00929` | 玩机技巧图片类正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00920` | 任务管理器图片类正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00932` | 音乐图片类正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00936` | 通知中心图标正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00935` | 主题图片类正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_00925` | 天气图片类正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0049` | 东方航空首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0022` | 腾讯视频首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0019` | 哔哩哔哩首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0032` | 腾讯新闻首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0038` | 滴滴出行首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0028` | 央广网首页、耳闻、央广号页面图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0033` | 得物首页、购买页面图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0044` | 亲宝宝育儿、商城页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0039` | 贝壳找房首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0035` | 同花顺首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0034` | 知乎首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0036` | 小红书首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0037` | 阳光惠生活首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0031` | 新浪新闻首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0007` | 汽车之家首页、选车、新车页面图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0080` | 钉钉首页页面图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0024` | 作业帮首页、练习页面图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0017` | 抖音首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0063` | 中国移动首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0016` | 快手首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0051` | 虎嗅资讯页面图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0053` | 去哪儿首页图片正常展示 | 组件1组 |
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0055` | 同城旅行首页图片正常展示 | 组件1组 |
...
| `SUB_ACE_UI_COMPONENT_MEDIA_IMAGE_APP_0056` | 平安好车主首页图片正常展示 | 组件1组 |

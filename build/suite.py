...
class XDeviceBuilder:
    ...
    def build_xdevice(self):
        ...
        if (xtssuite_out_dir.find('/acts/') != -1):
            acts_validator_dir = os.path.join(self.args.suite_out_dir, '../acts_validator')
            acts_validator_tools_dir = os.path.join(self.args.suite_out_dir, '../acts_validator/tools')
            acts_validator_sign_dir = os.path.join(self.args.suite_out_dir, '../acts_validator/sign')
        ...
        if self.args.configs_dir:
            ...
            if (xtssuite_out_dir.find('/acts/') != -1):
                acts_validator_config_dir = os.path.join(self.args.suite_out_dir, '../acts_validator/config')

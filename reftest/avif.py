...
class Test(unittest.TestCase):
    ...
    def test_avif_001(self):
        self.LE.init_runner('test_avif_001')  # 打开runner页面
        self.LE.click_js()  # 取消勾选js
        self.LE.click_manual()  # 取消勾选manual
        self.LE.send_path('avif/animated-avif-timeout.html')  # 是否进入指定路径 默认是/ 即全部路径
        ...
        self.LE.runner_end('test_avif_001')

...
class Test(unittest.TestCase):
    ...
    def test_preload_001(self):
        self.LE.init_runner('test_preload_001')  # 打开runner页面
        self.LE.click_js()  # 取消勾选js
        self.LE.click_manual()  # 取消勾选manual
        self.LE.send_path('preload/preload-in-data-doc.html')  # 是否进入指定路径 默认是/ 即全部路径
        self.LE.start_test()  # 点击start test 按钮
        self.LE.click_show_test()  # 点击show test按钮
        self.LE.test_screenshot('/html', "test")  # test页面截图
        ...
        self.LE.runner_end('test_preload_001')

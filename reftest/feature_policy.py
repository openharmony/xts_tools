...
class Test(unittest.TestCase):
    ...
    def test_feature_policy_001(self):
        self.LE.init_runner('test_feature_policy_001')  # 打开runner页面
        self.LE.click_js()  # 取消勾选js
        self.LE.click_manual()  # 取消勾选manual
        self.LE.send_path('feature-policy/experimental-features/vertical-scroll-disabled-scrollbar-tentative.html')  # 是否进入指定路径 默认是/ 即全部路径
        ...
        self.LE.runner_end('test_feature_policy_001')

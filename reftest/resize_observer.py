...
class Test(unittest.TestCase):
    ...
    def test_resize_observer_001(self):
        self.LE.init_runner('test_resize_observer_001')  # 打开runner页面
        self.LE.click_js()  # 取消勾选js
        self.LE.click_manual()  # 取消勾选manual
        self.LE.send_path('resize-observer/devicepixel.html')  # 是否进入指定路径 默认是/ 即全部路径
        self.LE.start_test()  # 点击start test 按钮
        self.LE.click_show_test()  # 点击show test按钮
        self.LE.test_screenshot('//*[@id="canvas2D"]', "test")  # test页面截图
        self.LE.test_screenshot('//*[@id="canvas2DPadding14"]', "test")  # test页面截图
        ...
        self.LE.runner_end('test_resize_observer_001')

    def test_resize_observer_002(self):
        self.LE.init_runner('test_resize_observer_002')  # 打开runner页面
        self.LE.click_js()  # 取消勾选js
        self.LE.click_manual()  # 取消勾选manual
        self.LE.send_path('resize-observer/devicepixel2.html')  # 是否进入指定路径 默认是/ 即全部路径
        self.LE.start_test()  # 点击start test 按钮
        self.LE.click_show_test()  # 点击show test按钮
        ...
        self.LE.test_assert("test", "ref")  # 断言
        self.LE.runner_end('test_resize_observer_002')

    def test_resize_observer_003(self):
        self.LE.init_runner('test_resize_observer_003')  # 打开runner页面
        self.LE.click_js()  # 取消勾选js
        self.LE.click_manual()  # 取消勾选manual
        self.LE.send_path('resize-observer/iframe-same-origin.html')  # 是否进入指定路径 默认是/ 即全部路径
        self.LE.start_test()  # 点击start test 按钮
        self.LE.click_show_test()  # 点击show test按钮
        ...
        self.LE.test_assert("test", "ref")  # 断言
        self.LE.runner_end('test_resize_observer_003')

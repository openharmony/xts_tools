...
class Test(unittest.TestCase):
    ...
    def test_apng_001(self):
        self.LE.init_runner('test_apng_001')  # 打开runner页面
        self.LE.click_js()  # 取消勾选js
        self.LE.click_manual()  # 取消勾选manual
        self.LE.send_path('apng/animated-png-timeout.html')  # 是否进入指定路径 默认是/ 即全部路径
        ...
        self.LE.runner_end('test_apng_001')

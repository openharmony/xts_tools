# Design Issues Report — §16.5.1 Asynchronous Lock

## Identified Issues

### 1. Stdlib Dependency (Asynchronous Lock)
- **Issue**: Asynchronous Lock relies on the underlying standard library (libc/libstdc++/C++ standard library).
- **Status**: The platform's stdlib implementation may not yet provide stable async-aware asynchronous lock primitives.

...
经 es2panda + ark VM 实测，以下行为与 ArkTS spec §7.27 一致：

| 行为 | 验证方式 | 结果 |
|------|---------|------|
| 关系表达式（< > <= >= instanceof），数值比较基于IEEE 754/整数语义，bigint比较按数学值，string按字典序，boolean按false<true，char按码点 | 10 compile-pass + 10 compile-fail + 10 runtime | ✅ 全部通过 |
...
| Spec 一致性 | ✅ 与 arktsspecification.md §7.27 一致 | ✅ JLS SE21 | ✅ Swift 5.10 | N/A |

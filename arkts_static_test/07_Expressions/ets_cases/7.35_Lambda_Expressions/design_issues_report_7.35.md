...
经 es2panda + ark VM 实测，以下行为与 ArkTS spec §7.35 一致：

| 行为 | 验证方式 | 结果 |
|------|---------|------|
| Lambda表达式（(params) => body），函数字面量，类型由签名+返回类型推导 | 10 compile-pass + 10 compile-fail + 10 runtime | ✅ 全部通过 |
...
| Spec 一致性 | ✅ 与 arktsspecification.md §7.35 一致 | ✅ JLS SE21 | ✅ Swift 5.10 | N/A |
